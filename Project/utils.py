...
def train(model, loader, total_epoch=10, learning_rate=1e-3, loss_function=None, optimizer=None, scheduler=None, save_path='./model', save_name='model'):
    ...
    for epoch in range(1, total_epoch + 1):
        ...
        print(f'(train) epoch loss: {epoch_loss:.4f}, fragment accuracy: {fragment_accuracy:.2%}, puzzle accuracy: {puzzle_accuracy:.2%}')
        ...
        print(f'(test) epoch loss: {epoch_loss:.4f}, fragment accuracy: {fragment_accuracy:.2%}, puzzle accuracy: {puzzle_accuracy:.2%}')
